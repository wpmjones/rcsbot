...
def challenge_1():
    challenge = ("**Reddit Electrum Challenge:**\n"
                 "Clash of clans offered a one time limited edition Halloween trap that was added to the game "
...
def challenge_2a():
    challenge = ("**Reddit Eclipse Challenge A:**\n"
                 "You are given the choice of walking through three doors. One is filled with deadly assassins "
...
def challenge_2b():
    challenge = ("**Reddit Elclipse Challenge B:**\n"
                 "In Boston, a man is found dead on a Sunday morning in his study. His wife calls the police "
...
def challenge_2c():
    challenge = ("**Reddit Eclipse Challenge C:**\n"
                 "A man shoots his wife three times in the park but she is still alive. Then he asks her if "
                 "she’s ready to go to dinner and she agrees as if nothing has happened.  What explains this?")
    return challenge


def challenge_3():
    challenge = ("**Reddit Zero Challenge:**\n"
                 "Share a pic of your favorite (or favourite) Halloween treat or candy in the "
                 "#trick-or-treat channel.")
    return challenge


def challenge_4():
    challenge = ("**Reddit Pi Challenge:**\n"
                 "Members of Reddit Pis leadership each like a different clash candy.\n\n"
...
def challenge_6():
    challenge = ("**Reddit Tau Challenge:**\n"
                 "Check out the Tau co-leaders! Which co-leader has TWO of the very first Halloween "
...
def challenge_7():
    challenge = ("**Reddit Argon Challenge:**\n"
                 "Find the spooky pic of a severely malnourished (you could say...skeletal) man playing clash "
                 "in the #trick-or-treat channel.  What's the brand name on the bottle he keeps close at hand?")
    return challenge


def challenge_8():
    challenge = ("**Dartaholics Challenge:**\n"
                 "Change your pfp/avatar to something including a pumpkin! Once you have, ask someone else "
                 "in the Dartaholics to enter the command `++pumpkin @your_name`")
    return challenge


def challenge_9():
    challenge = ("**Reddit Hunters Challenge:**\n"
                 "The following passwords have all been used in the RCS in the past:\n\n"
                 "(A) ramen\n"
                 "(B) popcorn\n"
                 "(C) pretzels\n"
                 "(D) bacon\n"
...
def challenge_10():
    challenge = ("**Reddit Ace Challenge:**\n"
                 "Find your favorite spooky picture and @ the leader (SAQ) with that image.  Who knows?  "
                 "Maybe it will end up as his profile picture!")
    return challenge


def challenge_11():
    challenge = ("**Extremeillusion Challenge:**\n"
...
def challenge_12():
    challenge = ("**Reddit Night Challenge:**\n"
                 "Edit your nickname here to include one or more of this emoji: :bat: !")
    return challenge


def challenge_13():
    challenge = ("**DIZZYS PLAYGRND Challenge:**\n"
                 "Time to play hide and seek!  A player in DIZZYS PLAYGRND is using this base!  Please view the "
...
def challenge_14():
    challenge = ("**Reddit Pirates Challenge:**\n"
                 "Those sneaky Pirates have hidden their bounty where they think you'll never find it. "
                 "But we have faith!\n\n"
...
def challenge_15():
    challenge = ("**Reddit Zulu Challenge:**\n"
                 "Today, there are MANY more and many with diverse clan names that don't include the word 'Reddit', "
